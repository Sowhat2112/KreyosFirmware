...
#define BUTTON_NO_ICON	0
#define TRIANGLE_UP	1
#define TRIANGLE_DOWN	2
#define TRIANGLE_RIGHT	3
#define TRIANGLE_LEFT	4

#define MUSIC_PAUSE	5
#define MUSIC_NEXT	6
#define MUSIC_PREVIOUS	7

#elif defined(PRODUCT_W002)  
#define KEY_UP          2
#define KEY_DOWN        3
#define KEY_ENTER       0
#define KEY_EXIT        1
...
extern void window_button(tContext *pContext, uint8_t key, uint8_t icon_type, const char* text);
#else
