...
void draw_screen(tContext *pContext)
{
  	...
  	if (state == BT_ON)
  	{
		...
		window_button(pContext, KEY_UP|0x80, TRIANGLE_RIGHT, "OFF");
		window_button(pContext, KEY_DOWN|0x80, TRIANGLE_RIGHT, "Exit");
#else            
...
#if defined(PRODUCT_W002) || defined(PRODUCT_W004)  
		window_button(pContext, KEY_DOWN|0x80, TRIANGLE_RIGHT, "ON");
#else        
