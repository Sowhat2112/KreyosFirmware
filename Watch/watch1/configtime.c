...
static void OnDrawTime(tContext *pContext)
{
  	...
  	GrContextFontSet(pContext, (const tFont*)&g_sFontRondablod25); 
#else  
	...
	GrContextFontSet(pContext, &g_sFontRondablod20b);
  	...
  	{
#if defined(PRODUCT_W002) || defined(PRODUCT_W004)  
		window_button(pContext, KEY_EXIT|0x80, TRIANGLE_LEFT, "Exit"); 
#else  	
...
#if defined(PRODUCT_W002) || defined(PRODUCT_W004)  
	GrContextFontSet(pContext, &g_sFontHelvetic18);
#else
