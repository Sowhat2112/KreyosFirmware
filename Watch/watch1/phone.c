...
#if defined(PRODUCT_W002) || defined(PRODUCT_W004)    	
  		window_button(pContext, KEY_EXIT|0x80, TRIANGLE_LEFT, "Hang up");
    		// volume
...
#if defined(PRODUCT_W002) || defined(PRODUCT_W004)    	
  		window_button(pContext, KEY_EXIT|0x80, TRIANGLE_LEFT, "Decline");
  		window_button(pContext, KEY_UP|0x80 ,TRIANGLE_RIGHT, "Answer");
#else            
