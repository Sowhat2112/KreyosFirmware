...
void window_init(uint8_t reason)
{
  ...
  if (reason == 0xff)
  {
    // draw the text
#if defined(PRODUCT_W002) || defined(PRODUCT_W004)  
		GrContextFontSet(&context, &g_sFontRonda18);
  		GrStringDrawCentered(&context, "SMART", -1, 72 , 10, 0);
  		GrStringDrawCentered(&context, "WATCH", -1, 72 , 40, 0);
...
static uint8_t messagebox_process(uint8_t ev, uint16_t lparam, void* rparam)
{
  switch(ev)
  {
    ...
    case EVENT_WINDOW_PAINT:
    {
      ...
      {
#if defined(PRODUCT_W002) || defined(PRODUCT_W004)  
		GrContextFontSet(pContext, (tFont*)&g_sFontRondablod25);
#else	      	
      ...
      {
#if defined(PRODUCT_W002) || defined(PRODUCT_W004)  
	window_button(pContext, KEY_ENTER | 0x80, BUTTON_NO_ICON, "Confirm");        
#else            	
      ...
      {
#if defined(PRODUCT_W002) || defined(PRODUCT_W004)  
	window_button(pContext, KEY_ENTER | 0x80, BUTTON_NO_ICON, "Dismiss");        
#else      	      	      	
	...
	window_button(pContext, KEY_ENTER | 0x80, BUTTON_NO_ICON, "OK");        
      ...
      {
#if defined(PRODUCT_W002) || defined(PRODUCT_W004)  
	window_button(pContext, KEY_UP | 0x80, TRIANGLE_RIGHT, "YES");
        window_button(pContext, KEY_DOWN | 0x80, TRIANGLE_RIGHT, "NO"); 
#else      	
